...
- [Synchronized Sony (left) versus RF (right), four seconds](images/showcase/sony-vs-rf.mp4).
...
[![VHS phase preview](images/motion/boss-vhs_sp_consumer.gif)](images/motion/boss-vhs_sp_consumer.mp4)

[Four seconds of the separate VHS SP preset](images/motion/boss-vhs_sp_consumer.mp4)
...
changes come from signal/CRT state. [Lossless native phase detail](images/motion/boss-vhs_sp_consumer-detail.webp).
...
[Sequence measurements](gpu-motion-metrics.json) include all source frame numbers and per-frame light statistics. The file now records the refreshed 120- or 240-frame clips, including all five showcase games.
