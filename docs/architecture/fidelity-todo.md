...
- [ ] 28. M/M-L/M. TV audio circuits (PVM AN5278, Toshiba network); AV emitter-follower nonlinearity at a calibrated level; circuit-derived hum and buzz; CPU audio chain by default. WP-I.
