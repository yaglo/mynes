...
The optional VHS stage filters recovered luma and chroma separately before the TV receiver, with chroma-envelope delay, residual line timing/phase errors and noise. It applies only to NTSC composite/RF. The separate VHS SP preset uses estimated recovered bandwidths rather than a magnetic recording or particular VCR simulation. [Model details, measurements and limitations](architecture/gpu-realism-validation.md).
