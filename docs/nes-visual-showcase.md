...
[Close-up of the same frame](images/showcase/4k/castlevania-pvm-detail.png) · [All 20 presets on Contra](contra-preset-gallery.md)
...
[Full-resolution gameplay and native close-ups](gpu-beam-closeups.md) show the beam, grille and brightness-dependent scanline width. Full game captures are 3840×2880; the four-preset title comparison uses 3840×2160 canvases with a 4:3 game viewport.
