 ...
 * frame; audio is queued in a ring and sent as 400-frame packets ahead of the
 * next video frame. Opening probes the box for audio support. */
...
/* Audio packets sent, the box's queue level in frames, its underrun count and
 * frames dropped on the host side, from the most recent acknowledgement. */
